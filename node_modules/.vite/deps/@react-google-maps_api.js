...
var ClusterIcon = function() {
  ...
  ClusterIcon2.prototype.onAdd = function() {
    ...
    this.boundsChangedListener = google.maps.event.addListener(this.getMap(), "boundschanged", function boundsChanged() {
...
var CALCULATOR = function CALCULATOR2(markers, numStyles) {
...
var Clusterer = function() {
  ...
  Clusterer2.prototype.createClusters = function(iFirst) {
    ...
    var mapBounds = this.getMap().getZoom() > 3 ? new google.maps.LatLngBounds(this.getMap().getBounds().getSouthWest(), this.getMap().getBounds().getNorthEast()) : new google.maps.LatLngBounds(new google.maps.LatLng(85.02070771743472, -178.48388434375), new google.maps.LatLng(-85.08136444384544, 178.00048865625));
